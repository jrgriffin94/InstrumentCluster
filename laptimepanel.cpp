...
LapTimePanel::LapTimePanel(QWidget *parent, QRect sizeLoc)
    : QWidget(parent)
{
    ...
    lap_num->display(0);
    lap_num->setGeometry(sizeLoc.width() * 0.15, 0, 100, sizeLoc.height() * 0.10);
    ...
    lap_label->setGeometry(0, 0, sizeLoc.width() * 0.5, sizeLoc.height() * 0.10);
    ...
    last_label->setGeometry(0, sizeLoc.height() * 0.33,  sizeLoc.width(), sizeLoc.height() * 0.15);
    ...
    last_time_label->setGeometry(0, sizeLoc.height() * 0.45,  sizeLoc.width(), sizeLoc.height() * 0.10);
    ...
    best_label->setGeometry(0, sizeLoc.height() * 0.66,  sizeLoc.width(), sizeLoc.height() * 0.15);
    ...
    best_time_label->setGeometry(0, sizeLoc.height() * 0.78,  sizeLoc.width(), sizeLoc.height() * 0.10);
...
void LapTimePanel::setLastTime(int time)
{
    ...
    QString string;
    string = "%1:%2:%3";
    string = string.arg(minutes, 2, 'g', 2, '0').arg(seconds, 2, 'g', '0').arg(msecs, 3, 'g', 3, '0');
